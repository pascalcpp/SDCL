...
def conv3x3_2d_bn_relu(in_planes, out_planes, stride=1):
    return nn.Sequential(
        conv3x3_2d(in_planes, out_planes, stride),
...
class ResNet2d(nn.Module):
    ...
    def __init__(self, block, layers, in_channel=1, width=1,
        ...
        if deep_stem:
            ...
            self.conv1 = nn.Conv2d(in_channel, self.inplanes, kernel_size=7, stride=1, padding=3, bias=False)
